...
|---|---|
| Product PRD | `.claude/templates/product-prd.md` |
| Architecture decision record | `.claude/templates/adr.md` |
| Every non-minimal business feature | `.claude/templates/categories/base-slice.md` |
| Global rules file (`memory/rules.md`) | `.claude/templates/categories/rules.md` |
