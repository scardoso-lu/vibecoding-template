...
Read the memory path supplied by the orchestrator: the feature's `slice.md`, the global
...
You are read-only: you never write `slice.md` yourself. The orchestrator relays your confirmed
