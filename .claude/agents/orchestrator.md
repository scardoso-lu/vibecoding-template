...
Every request starts here, before any implementer/QA agent is ever routed. This is the full
...
- Record both final acceptance percentages and the round count when you emit Execution Routing.
