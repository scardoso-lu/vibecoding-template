...
The `orchestrator` sequences you before `business-challenger`. The main conversation thread is the
hub.
...
- Do not emit implementation routes. The `orchestrator` owns routing.
