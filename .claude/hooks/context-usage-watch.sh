...
# instruction (PostToolUse additionalContext) telling Claude to write the repo-root
...
def main() -> int:
    ...
    sentinel = os.path.join(tempfile.gettempdir(), f"claude-handoff-notified-{session_id}")
