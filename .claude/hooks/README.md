...
cannot. The planning prompt gates are intentionally model-backed because PRD and ADR quality is
judgment work; deterministic validators only check registration and artifact shape.
