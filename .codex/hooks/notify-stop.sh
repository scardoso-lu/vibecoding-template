...
case "$speak_with" in
  ...
  powershell) NOTIFY_PHRASE="$PHRASE" powershell.exe -NoProfile -WindowStyle Hidden -Command '
Add-Type -AssemblyName System.Speech
(New-Object System.Speech.Synthesis.SpeechSynthesizer).Speak($env:NOTIFY_PHRASE)
' ;;
