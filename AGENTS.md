...
4. Block subagent reads of agent infrastructure.
   ...
   names the exact path. QA may read `.codex/skills/playwright-cli/**` for Playwright spec work.
...
The planner reads `.codex/templates/template-routing.md`, loads only the needed category
